...
<div id="successMessage" style="display: none;" class="alert alert-success">Product file uploaded successfully</div>
<div id="errorMessage" style="display: none;" class="alert alert-danger">Failed to upload product file</div>
...
<script>
    $(document).ready(function () {
        $('#uploadButton').click(function () {
            ...
            $.ajax({
                url: '${createLink(controller: 'product', action: 'saveUpload')}',
                type: 'POST',
                data: formData,
                timeout:30000,
                processData: false,
