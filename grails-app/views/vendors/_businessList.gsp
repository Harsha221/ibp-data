                ...
                <td>
                    <div class="input-group-btn" >
                        ...
                        <ul class="dropdown-menu pull-right" style="min-width: 100px !important;">
                            <li>
                                <sec:link params="[name: 'businessList']" action="edit" id="${data?.vendorId}" data-job-id="${data?.vendorId}" class="status-link"><i class="fa fa-edit"></i>Edit</sec:link>
                            </li>
                                <li> <a data-job-id="${data?.id}" class="status-link" data-toggle="modal" data-target="#business_activation_form" style="cursor: pointer">
                                    <i class="fa fa-check"></i>Mark as Verified</a>
                                </li>
                        </ul>
                    </div>
                </td>
