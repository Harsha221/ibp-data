    ...
    <div class="col-md-10">
        ...
        <div class="panel ">
            ...
            <div class="panel-body">
                <form:validateUploadForm name="update-advertisementRateCard" action="update" id="${this.advertisementRateCard?.id}" method="put" class="form-horizontal bv-form" novalidate="novalidate" >
